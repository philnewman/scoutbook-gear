...
var mobilehide = document.getElementById('mobilehide');

if (window.mobilecheck()){
      var mobilehide = document.getElementById('mobilehide');
      mobilehide.style.display = 'none';
      mobileshow.style.display = "inline";
}else{
      mobileshow.style.display = 'none';
      mobilehide.style.display = 'inline';
      die;
}
    ...
    startScanner();
        ...
        function startScanner() {
            ...
            Quagga.onDetected(function (result) {
                ...
                var gear_url = "https://troop351.org/gear/" + result.codeResult.code;
                console.log('Redirecting to ' + gear_url);
                //Quagga.stop();
                window.location.replace(gear_url);
            });
        } 
